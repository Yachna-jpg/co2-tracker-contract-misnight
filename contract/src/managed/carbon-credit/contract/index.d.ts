...
export type ImpureCircuits<PS> = {
  recordCredit(context: __compactRuntime.CircuitContext<PS>, details_0: string): __compactRuntime.CircuitResults<PS, []>;
  retireCredit(context: __compactRuntime.CircuitContext<PS>): __compactRuntime.CircuitResults<PS, string>;
}
