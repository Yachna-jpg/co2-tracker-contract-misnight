...
/*
 * This file defines the shape of the carbon credit tracker's private state,
 * as well as the single witness function that accesses it.
 */

import { Ledger } from "./managed/carbon-credit/contract/index.js";
import { WitnessContext } from "@midnight-ntwrk/midnight-js-protocol/compact-runtime";

/* **********************************************************************
 * The only hidden state needed by the carbon credit tracker contract is
...
export type CarbonCreditPrivateState = {
  readonly secretKey: Uint8Array;
};

export const createCarbonCreditPrivateState = (secretKey: Uint8Array) => ({
  secretKey,
});

/* **********************************************************************
 * The witnesses object for the carbon credit tracker contract is an object
 ...
 *  is the private state type, like CarbonCreditPrivateState defined above.
 *
 ...
 * the declared return value.  In this case, that's a CarbonCreditPrivateState
...
export const witnesses = {
  localSecretKey: ({
    privateState,
  }: WitnessContext<Ledger, CarbonCreditPrivateState>): [
